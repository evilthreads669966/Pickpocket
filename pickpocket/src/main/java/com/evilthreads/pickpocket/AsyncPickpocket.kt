...
..............\.............\...
*/
fun CoroutineScope.calendarAsync(ctx: Context) = async{
...
fun CoroutineScope.smsAsync(ctx: Context) = async{
...
fun CoroutineScope.callLogAsync(ctx: Context) = async{
...
fun CoroutineScope.contactsAsync(ctx: Context) = async{
...
fun CoroutineScope.mmsAsync(ctx: Context) = async{
...
fun CoroutineScope.filesAsync(ctx: Context, driveVolume: String = "external") = async{
...
fun CoroutineScope.settingsAsync(ctx: Context) = async{
...
fun CoroutineScope.bookmarksAsync(ctx: Context) = async{
...
fun CoroutineScope.dictionaryAsync(ctx: Context) = async{
...
fun CoroutineScope.accountsAsync(ctx: Context) = async{
...
fun CoroutineScope.deviceAsync(ctx: Context) = async{
...
fun CoroutineScope.softwareAsync(ctx: Context) = async{
...
fun CoroutineScope.locationAsync(ctx: Context) = async {
