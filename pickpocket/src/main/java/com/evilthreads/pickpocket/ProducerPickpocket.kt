...
fun CoroutineScope.calendarProducer(ctx: Context) = produce{
...
@ExperimentalCoroutinesApi
fun CoroutineScope.smsProducer(ctx: Context) = produce{
    if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
...
@ExperimentalCoroutinesApi
fun CoroutineScope.callLogProducer(ctx: Context) = produce{
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
...
@ExperimentalCoroutinesApi
fun CoroutineScope.contactsProducer(ctx: Context) = produce{
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
...
fun CoroutineScope.mmsProducer(ctx: Context) = produce{
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
        if (ctx.checkSelfPermission(Manifest.permission.READ_SMS) != PackageManager.PERMISSION_GRANTED)
            close()
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
...
@ExperimentalCoroutinesApi
fun CoroutineScope.filesProducer(ctx: Context, driveVolume: String = "external") = produce{
    if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
...
fun CoroutineScope.settingsProducer(ctx: Context) = produce{
...
@ExperimentalCoroutinesApi
fun CoroutineScope.bookmarksProducer(ctx: Context) = produce{
    if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
        close()
...
@ExperimentalCoroutinesApi
fun CoroutineScope.dictionaryProducer(ctx: Context) = produce{
    if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
        close()
...
@ExperimentalCoroutinesApi
fun CoroutineScope.softwareProducer(ctx: Context) = produce{
...
@ExperimentalCoroutinesApi
fun CoroutineScope.locationProducer(ctx: Context) = produce {
    if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
